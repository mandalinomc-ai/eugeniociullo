        ...
        <div className="grid grid-cols-1 sm:grid-cols-[1fr_10.5rem] lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 xl:gap-16 items-center">
          <div className="flex flex-col justify-center space-y-4 sm:space-y-5 min-w-0">
            ...
            >
              ...
              analisi e campagne ADS. Con{" "}
              <span className="text-white font-medium">ZeroAgency</span> facciamo conoscere e
              convertire le attività che seguiamo — ogni servizio al servizio del risultato.
            </motion.p>
          ...
          >
            ...
            <div className="hidden lg:flex flex-col w-full max-w-[17rem] xl:max-w-[19rem] gap-4">
              <HeroCtas />
              <div className="card-surface rounded-2xl p-4 sm:p-5 transition-transform duration-500 hover:-translate-y-1">
