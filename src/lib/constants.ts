...
export const BRANDS = [
  ...
  },
  {
    ...
    highlight: "119K views IG + 70.5K TikTok · locale sold-out dal lancio.",
...
export const LANCI_DA_ZERO = [
  ...
  },
  {
    ...
    tag: "Lanciato da zero",
    preAnalysis:
      "Fase di pre-analisi: studio del mercato Telese, analisi target ristorazione di pesce e definizione format Reels su Instagram e TikTok prima del go-live.",
    instagramRef:
      "119.111 views IG · 70.5K views TikTok · 88,8% traffico da For You · dati da dashboard professionali",
  },
] as const;
...
export const LAUNCH_REPORTS = [
  ...
  },
  {
    ...
    subtitle: "Ittico Telese · Lancio Instagram + TikTok",
    period: "2 giu – 1 lug · Ultimi 30 giorni",
    organicNote:
      "Oltre a Instagram: crescita organica su TikTok con picco di visualizzazioni e traffico quasi tutto dal feed For You — engagement reale su contenuti food.",
    stats: [
      { label: "Visualizzazioni IG", value: "119.111", highlight: true },
      { label: "Views TikTok", value: "70.5K", highlight: true },
      { label: "Traffico For You", value: "88,8%" },
      { label: "Crescita follower", value: "+84,1%" },
      { label: "Interazioni IG", value: "1.877" },
      { label: "Risultato", value: "SOLD OUT" },
    ],
    frames: [
      {
      ...
      },
      {
        ...
        bg: "bg-white",
        padding: "p-1",
        label: "Dashboard Insights IG",
      },
      {
        src: "/images/ittico/tt-analytics.png",
        alt: "Analytics TikTok ITTICO 70.5K visualizzazioni post",
        fit: "contain" as const,
        position: "center top",
        bg: "bg-white",
        padding: "p-1",
        label: "Analytics TikTok · 70,5K",
      },
      {
        src: "/images/ittico/tt-activity.png",
        alt: "Attività TikTok ITTICO - visualizzazioni profilo e mi piace",
        fit: "contain" as const,
        position: "center top",
        bg: "bg-white",
        padding: "p-1",
        label: "Attività · engagement",
      },
    ],
  },
] as const;
