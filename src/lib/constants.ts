...
export const LAUNCH_REPORTS = [
  ...
  },
  {
    ...
    subtitle: "Benevento · Lancio organico Instagram + TikTok",
    period: "Prime settimane dal lancio · zero sponsor",
    organicNote:
      "Abbiamo convertito un pubblico freddo che non ci conosceva: commenti con richieste di indirizzo, recensioni e DM — tutto organico, senza campagne a pagamento.",
    collaboration: {
    ...
    stats: [
      ...
      { label: "Crescita IG", value: "+2.504%", highlight: true },
      { label: "Visite profilo IG", value: "3.507" },
    ...
    frames: [
      {
        src: "/images/parisio/ig-profile.png",
        alt: "Profilo Instagram @parisiotrattoriacontemporanea",
        fit: "contain" as const,
        position: "center top",
        bg: "bg-white",
        padding: "p-2 sm:p-3",
        aspect: "aspect-[4/5] sm:aspect-[9/16]",
        label: "Profilo Instagram",
      },
      {
        src: "/images/parisio/ig-activity.png",
        alt: "Attività profilo Instagram Parisio +2504%",
        fit: "contain" as const,
        position: "center top",
        bg: "bg-white",
        padding: "p-2 sm:p-3",
        aspect: "aspect-[4/5] sm:aspect-[9/16]",
        label: "Attività profilo · +2.504%",
      },
      {
        src: "/images/parisio/tt-dashboard.png",
        alt: "Dashboard TikTok Parisio 70.820 visualizzazioni",
        fit: "contain" as const,
        position: "center top",
        bg: "bg-white",
        padding: "p-2 sm:p-3",
        aspect: "aspect-[4/5] sm:aspect-[9/16]",
        label: "Dashboard TikTok",
      },
      {
